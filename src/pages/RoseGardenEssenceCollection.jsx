...
const RoseGardenEssenceCollection = () => {
  ...
  // Fetch rose garden essence scents
  const fetchRoseGardenEssenceScents = useCallback(async () => {
    try {
      setLoading(true);
      setError(null);
      ...
      const response = await ScentService.getRoseGardenEssenceScents(params);
      ...
      if (response.success) {
        ...
        setError(response.message || 'Failed to fetch rose garden essence scents');
        setScents([]);
      }
    } catch (err) {
      console.error('Error fetching rose garden essence scents:', err);
      setError('Failed to load rose garden essence scents');
      setScents([]);
    } finally {
      setLoading(false);
    }
          ...
          <div className="max-w-7xl mx-auto">
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">
                  No rose garden essence scents found
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
              ...
              <>
                {/* <div className="mb-6 text-center">
                  <p className="text-gray-600 dark:text-gray-400">
                    Showing {scents.length} of {totalPages * itemsPerPage} rose garden essence scents
                  </p>
                </div> */}
...
export default RoseGardenEssenceCollection;